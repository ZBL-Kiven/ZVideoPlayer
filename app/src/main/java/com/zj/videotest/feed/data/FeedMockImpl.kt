...
class FeedMockImpl(private val imgPath: String, private val dataType: DataType, private val videoPath: String = "") : FeedDataIn {
    ...
    companion object {
        fun createMock(): MutableList<FeedDataIn> {
            ...
            lst.add(FeedMockImpl("https://i.ytimg.com/vi/bPZc7avrCT4/hqdefault.jpg?sqp=-oaymwEcCPYBEIoBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLAPrfs2Bhirrkj87653AbMChENCVA", DataType.YTB, "https://youtu.be/npDKX_p0ZSk"))
            ...
            lst.add(FeedMockImpl("https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fhiphotos.baidu.com%2Ffeed%2Fpic%2Fitem%2F962bd40735fae6cded1edd4e05b30f2442a70f72.jpg&refer=http%3A%2F%2Fhiphotos.baidu.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1621007753&t=9267c0db34ecdf67ea3e114f17379a8f", DataType.GIF))
            lst.add(FeedMockImpl("https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fup.54fcnr.com%2Fpic_source%2F9c%2F0f%2Fde%2F9c0fdecd8a4ccb305fadda5081f6ea7b.gif&refer=http%3A%2F%2Fup.54fcnr.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1621007753&t=9faffea9390ade4aa11df93f7dfa4e5b", DataType.GIF))
            return lst
        }
    }
}