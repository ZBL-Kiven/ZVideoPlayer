...
class FeedMockImpl(private val imgPath: String, private val dataType: DataType, private val videoPath: String = "") : FeedDataIn {
    ...
    companion object {
        fun createMock(): MutableList<VideoSource> {
            ...
            lst.add(VideoSource("https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fdingyue.nosdn.127.net%2FEJX62VA7xMvog775uRrIsmWyvwSPb8759ltyi9bqolCV01545328642002.gif&refer=http%3A%2F%2Fdingyue.nosdn.127.net&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1633707032&t=2c9c6bf7ae9d468944d8aaaf7e6b844f", DataType.GIF, ""))
