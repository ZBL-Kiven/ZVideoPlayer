...
final class SeiReader {
    ...
    public void createTracks(ExtractorOutput extractorOutput, TrackIdGenerator idGenerator) {
        for(int i = 0; i < this.outputs.length; ++i) {
            ...
            output.format(Format.createTextSampleFormat(formatId, channelMimeType, (String)null, -1, channelFormat.selectionFlags, channelFormat.language, channelFormat.accessibilityChannel, (DrmInitData)null, 9223372036854775807L, channelFormat.initializationData));
